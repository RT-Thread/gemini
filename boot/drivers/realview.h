 ...
 */
#define REALVIEW_UART0_BASE         0x90C09000  /* UART 0 */
#define REALVIEW_UART1_BASE         0x90C0A000  /* UART 1 */
#define REALVIEW_UART2_BASE         0x90C0B000  /* UART 2 */
#define REALVIEW_UART3_BASE         0x90C0C000  /* UART 3 */
#define REALVIEW_SSP_BASE           0x90C0D000  /* Synchronous Serial Port */
#define REALVIEW_WATCHDOG0_BASE     0x90C0F000  /* Watchdog 0 */
#define REALVIEW_WATCHDOG_BASE      0x90C10000  /* watchdog interface */
#define REALVIEW_TIMER0_1_BASE      0x90C11000  /* Timer 0 and 1 */
#define REALVIEW_TIMER2_3_BASE      0x90C12000  /* Timer 2 and 3 */
#define REALVIEW_GPIO0_BASE         0x90C13000  /* GPIO port 0 */
#define REALVIEW_RTC_BASE           0x90C17000  /* Real Time Clock */
#define REALVIEW_TIMER4_5_BASE      0x90C18000  /* Timer 4/5 */
#define REALVIEW_TIMER6_7_BASE      0x90C19000  /* Timer 6/7 */
#define REALVIEW_SCTL_BASE          0x90C1A000  /* System Controller */
#define REALVIEW_CLCD_BASE          0x90C20000  /* CLCD */
#define REALVIEW_ONB_SRAM_BASE      0x90C60000  /* On-board SRAM */
#define REALVIEW_DMC_BASE           0x90CE0000  /* DMC configuration */
#define REALVIEW_SMC_BASE           0x90CE1000  /* SMC configuration */
#define REALVIEW_CAN_BASE           0x90CE2000  /* CAN bus */

#define REALVIEW_GIC_CPU_BASE       0x90E00100  /* Generic interrupt controller CPU interface */
#define REALVIEW_GIC_DIST_BASE      0x90E01000  /* Generic interrupt controller distributor */
