...
void rt_hw_mmu_init(void)
{
    ...
    /* set page table */
    /* 4G 1:1 memory */
    rt_hw_mmu_setmtt(0x8fB00000, 0x90000000-1, 0x6fB00000, RW_CB);
    rt_hw_mmu_setmtt(0x6fC00000, 0x70000000-1, 0x6fC00000, RW_CB);

    rt_hw_set_domain_register(0x55555555);
    rt_cpu_tlb_set((unsigned long *)((unsigned int)MMUTable - (0x8fB00000 - 0x6fB00000)));
